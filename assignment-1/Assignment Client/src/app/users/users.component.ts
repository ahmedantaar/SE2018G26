...
this.detailip.push(...Object.getOwnPropertyNames(items));
  ...
  /*  if(this.showAnswer1 == 0){
    ...
    else if(this.unique_array.includes("Answer") ){
        remove(this.unique_array,"Answer");
}
*/
        this.cols = [];
...
error =>  {
  ...
  console.log(this.car);
    ...
    this.DataService.updateVeiw(this.car.id, this.car , this.controller).subscribe(records => {
       this.Math();
...
this.displayDialog = false;
   ...
   console.log(this.controller);
    this.DataService.delete1(rowData._id , this.controller).subscribe(x => {
     this.Math();
